...
<body>
	...
	<c:set var="application" value="application 영역" scope="application" />
	...
	<br/>
	<br/>
	<a href="/index.jsp">index.jsp_경로_오류</a><br/>
	<c:url var="pageLink" value="/index.jsp"/>
	<h3>pageLink : ${pageLink}</h3>
	<a href="${pageLink}">메인으로_pageLink_Ver.</a><br/>
	<a href="<c:url value='/index.jsp'/>">메인으로_c:url_ver.</a><br/>
	<br/>
	<br/>
	<br/>
	<br/>
