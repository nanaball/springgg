...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	errorPage="error/error_400.jsp"
	pageEncoding="UTF-8"%>
	
<%-- 
<%!int i = 600;%>
<%String sqlTemp = "INSERT INTO test_member VALUES "
			+ "(null,?,?,'삼기근','부산광역시','01011111111','남성',30)";
...
<%
	...
	if(loginMember == null && cookies != null){
		// 로그인이 되어있지 않은 사용자 && 쿠키 정보 존재 
		for(Cookie c : cookies){
			if(c.getName().equals("rememberMe")){
				// 자동로그인 용으로 등록된 cookie
				String id = c.getValue();	// 자동 로그인용으로 등록된 사용자 id
