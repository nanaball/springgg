...
<body>
	...
	<%
		// 요청이 들어온 페이지 요청한 페이지 정보가 없을때는 1page 출력
		int currentPage = 1;
		// 한 페이지에 보여줄 게시물 개수
		int pageCount = 10;
...
<%
	...
	// 769/10	== 76.9 == 76 + 1 == 77 page
	// 130 : (130-1) / 10 == 13page + 1 == 14page
	// 129 : (129-1) / 10 == 12page + 1 == 13page

	// 이동 할 수 있는 페이지 번호 - 최대 페이지 번호 
	...
	// ... 
	// 시작 페이지 번호 
	// 1page : == 1 == (1-1) / displayPageNum = 5; == (0*5) +1 == 1
