<!-- request_test/requestResult.jsp -->
...
<body>
	<%
		// POST 방식일때, GET방식은 주소 창에서 미리 1BYTE로 바꿔서 문제X
		/*
		...
		*/
		...
		// 주소줄의 URL 요청 정보 
		// http://10.100.205.231:8080/05_implict_object_scope/request_test/requestResult.jsp
		StringBuffer requestURL = request.getRequestURL();
		out.println("requestURL : " + requestURL + "<br/>");
		
		// contextPath
		// WAS(web application server)에서 웹 application(프로젝트)를 구분하기 위한 경로 (path)
		// /05_implict_object_scope
		String contextPath = request.getContextPath();
		out.println("contextPath : " + contextPath + "<br/>");
		
		// queryString = get방식으로 전달된 parameters
	...
	<%
		...
		while(names.hasMoreElements()){
			// names 열거형에서 저정된 요소를 읽고 다음 요소로 이동
