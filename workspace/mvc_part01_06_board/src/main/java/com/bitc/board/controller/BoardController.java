...
public class BoardController {
	...
	public String registerPost(BoardVO vo, Model model) throws Exception{
		...
		System.out.println("board/register post요청");
	...
	public String readPage(
			...
			@ModelAttribute("cri") Criteria cri, int bno, Model model,
...
//		}
	...
	public String remove(RedirectAttributes rtts, int bno) throws Exception{
