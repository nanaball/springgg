 ...
 * TEXT - 최대 65535 byte (대략 64KB) - 3 byte - 21844 글자 저장가능
 * MEDIUPTEXT - 16777215 byte(16MB)
...
CREATE TABLE tbl_attach(
	fullName VARCHAR(300) NOT NULL,				-- 첨부파일이름
	bno INT NOT NULL,							-- 게시글 번호
	regdate TIMESTAMP NULL DEFAULT now(),		-- 등록시간
