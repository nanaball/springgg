...
public class SampleController {
	...
	public String doD(
			// 파라미터와 매개변수 이름이 서로 다를때				// 값이 null 일때 
	...
	public String doD(String msg, Model model) {
		// 매개변수 이름과 일치하는 파라미터를 request에서 찾아서 호출 시 전달 
		System.out.println("doD 호출 msg : " + msg);
...
//	public String product(String name, int price, Model model) {
...
//	}
	...
	// @PostMapping("productWriteSubmit") == RequestMapping(value="productWrite", method=RequestMethod.POST)
