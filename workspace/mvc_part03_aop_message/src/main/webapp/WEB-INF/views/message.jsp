...
<body>
	<input type="text" id="targetid" placeholder="수신자 아이디" /><br/>
	<input type="text" id="sender" placeholder="발신자 아이디" /><br/>
...
//					let opendate = getDate(msg.opendate);
		...
		function readMessage(mno, uid, element){
				...
				$.ajax({
					type: "PATCH",
					url : "messages/read/" +mno+"/"+uid,	// PATHVARIABLE - URL 경로상 움직이는 DATA
					dataType : "JSON",
					success : function(msg){
						// msg == 수신확인된 MessageVO 정보
						// 메세지 클릭시 수신확인에서 정보 바로 변경해서 전달 
